...
export default function RoleUpdate({ initialData, donePost }: any) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setLoading(true);
        try {
            const push: any = await apiRequest.put(`/roles/${initialData.id}`, formData);
            setLoading(false);
    ...
    return (
        <div id="hs-vertically-centered-modal-role-update" className="hs-overlay hidden ti-modal">
            <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                <div className="ti-modal-content">
                    <div className="ti-modal-header">
                        ...
                        <button type="button" id='modalCloseUpdate' className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#hs-vertically-centered-modal-role-update">
